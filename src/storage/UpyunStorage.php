...
class UpyunStorage extends Storage
{
    ...
    protected function initialize()
    {
        ...
        $this->domain = sysconf('storage.upyun_http_domain');
        ...
        else throw new \think\admin\Exception('未配置upyun URL域名哦');
        // 初始化配置并返回当前实例
    ...
    {
        return "{$this->prefix}/yanmen/uploads/{$this->delSuffix($name)}{$this->getSuffix($attname)}";
    }
     ...
     * @return void
     */
    public function save_url($name, $safe = false, $attname = null)
    {
        return "/yanmen/uploads/{$this->delSuffix($name)}{$this->getSuffix($attname)}";
    }
